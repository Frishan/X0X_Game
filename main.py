...
#in caz ca nu mai sunt spatii libere si nici un if nu e indeplinit e egalitate
    ...
    for row in range(3):
        for column in range(3):
            if buttons[row][column]['text'] != "":
                spaces -= 1
#pornim cu 9 spatii libere si in cand un buton este ocupat cu text scadem cate unu
    if spaces == 0:
        return False
    else:
        return True
